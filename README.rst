...
.. |commits-since| image:: https://img.shields.io/github/commits-since/bird-house/birdhouse-deploy/2.9.1.svg
    :alt: Commits since latest release
    :target: https://github.com/bird-house/birdhouse-deploy/compare/2.9.1...master

.. |latest-version| image:: https://img.shields.io/badge/tag-2.9.1-blue.svg?style=flat
    :alt: Latest Tag
    :target: https://github.com/bird-house/birdhouse-deploy/tree/2.9.1
