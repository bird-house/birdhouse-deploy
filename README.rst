...
.. |commits-since| image:: https://img.shields.io/github/commits-since/bird-house/birdhouse-deploy/2.0.3.svg
    :alt: Commits since latest release
    :target: https://github.com/bird-house/birdhouse-deploy/compare/2.0.3...master

.. |latest-version| image:: https://img.shields.io/badge/tag-2.0.3-blue.svg?style=flat
    :alt: Latest Tag
    :target: https://github.com/bird-house/birdhouse-deploy/tree/2.0.3
