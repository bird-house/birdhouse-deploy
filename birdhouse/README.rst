...
All variables that are set in the local environment file (``env.local`` by default) can also be specified as environment variables when running ``bin/birdhouse`` 
