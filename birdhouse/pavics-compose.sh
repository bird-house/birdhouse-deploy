...
# NOTE, this file is used by the autodeploy mechanism inside a very
# minimalistic container, therefore:
#
# * When making change to this file, should also test that is does not break
#   the autodeploy.
#
