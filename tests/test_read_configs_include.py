...
class TestReadConfigs(_ReadConfigs):
    ...
    def run_func(self, include_file: str,
        ...
        try:
            ...
            return super().run_func(include_file, {"BIRDHOUSE_LOCAL_ENV": f.name}, command_suffix, command, exit_on_error)
        finally:
            os.unlink(f.name)
