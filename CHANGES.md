...
- The `birdhouse/birdhouse-deploy` repositiory now makes more effective use of GitHub Workflows in order to automate
  ...
  tag is created, then the second workflow automatically publishes the new tag with an autogenerated summary of changes.
  Developers should no longer tag new releases manually.
